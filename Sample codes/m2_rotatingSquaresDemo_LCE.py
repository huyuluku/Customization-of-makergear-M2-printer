...
w = 10      # Width
nStrips = 6 # How many strips to print
...
# Start position
start = [30 + nozzleDiam, 30, -125.7 + z0]         # The starting global coordinates of the tool_head (do not change unless hardware changes)
